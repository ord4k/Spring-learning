...
public class OffersDAO {
	...
	//to get selected item by ID from the given table
	...
	//batch update (id=0 make up an ID using next available ID in database for this object)
	@Transactional
	...
	//to get a list of items from the given table
